...
if __name__ == "__main__":
    ...
    concerts = pd.read_csv("OrchestralManoeuvresInData/concerts.csv")
    works = pd.read_csv("OrchestralManoeuvresInData/works.csv")
    solo = pd.read_csv("OrchestralManoeuvresInData/soloists.csv")
